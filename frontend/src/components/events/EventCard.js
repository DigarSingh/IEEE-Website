    ...
    >
      ...
      <div className="p-5">
        ...
        <Link href={`/events/${event.id}`}>
          <span className="inline-block px-4 py-2 font-medium transition-colors bg-white border rounded-full cursor-pointer text-ieee-blue border-ieee-blue hover:bg-ieee-blue hover:text-white">
            View Details
          </span>
        </Link>
      </div>
