...
export default function AdminEvents() {
  ...
  return (
    <Layout>
      <Head>
        <title>Manage Events - IEEE Admin</title>
        <meta name="description" content="Manage IEEE events" />
      </Head>
        ...
        <div className="bg-gradient-to-r from-blue-900 to-purple-900 p-6">
          <div className="max-w-7xl mx-auto flex justify-between items-center">
            <div>
              ...
              <p className="text-blue-200">Create and manage IEEE events</p>
            </div>
            <Link
                        ...
                        <tr key={event._id} className="border-b border-gray-700 hover:bg-gray-700">
                          <td className="py-3 px-4">
                            <div>
                              ...
                              <p className="text-sm text-gray-400">{event.description?.substring(0, 50)}...</p>
                            </div>
                          </td>
                          <td className="py-3 px-4">
                          ...
                          <td className="py-3 px-4">
                            <span className={`px-3 py-1 rounded-full text-xs font-medium ${
                              event.status === 'upcoming' ? 'bg-green-900 text-green-200' :
                              event.status === 'ongoing' ? 'bg-blue-900 text-blue-200' :
