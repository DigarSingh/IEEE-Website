...
console.log('Creating build-safe AuthContext...');

const buildSafeAuthContext = `
...
// Path to the original AuthContext.js
...
if (!fs.existsSync(backupPath) && fs.existsSync(authContextPath)) {
  fs.copyFileSync(authContextPath, backupPath);
  console.log('Original AuthContext.js backed up to AuthContext.js.bak');
}

// Write the build-safe version
fs.writeFileSync(authContextPath, buildSafeAuthContext);
console.log('Build-safe AuthContext.js created successfully!');
